...
import { Cpu, Binary, Atom, Dna, HeartPulse, FlaskConical, Circle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto text-center space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {categories.map((cat) => {
            ...
            return (
              <Card key={cat.categoryId} hoverEffect={true} className="flex flex-col items-center justify-center p-6 bg-bg-page/40">
