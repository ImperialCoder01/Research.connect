    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div>
        <div className="flex justify-between items-center mb-1.5">
          ...
          <Link
            to="/forgot-password"
            className="text-xs font-semibold text-primary hover:text-primary-600 transition"
          >
            Forgot password?
          </Link>
        </div>
      ...
      <div className="flex items-center">
        <input
          ...
          name="remember-me"
          type="checkbox"
          className="h-4.5 w-4.5 rounded border-border bg-white text-primary focus:ring-primary/20 focus:ring-offset-white"
        />
